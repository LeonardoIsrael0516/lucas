...
Para obter X-API-Key e X-API-Secret, entre no painel e abra API / Chaves (é necessário estar logado).
Referência completa de campos e rotas adicionais (perfil, KYC): veja o arquivo docs/API.md no repositório.