		...
		<div class="row">
			<div class="col-lg-9">
					...
					<div class="row">
						<div class="col-lg-3 mt-5 info-body-cartao">
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputEmail1">Descrição do produto: (<em
										class="atributo">name</em>)<br><strong class="ex">Ex: Monitor
										LCD</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="descricao"
									placeholder="Descrição do produto">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Valor do produto: (<em
										class="atributo">value</em>)<br><strong class="ex">Ex: 5000 (equivale a R$
										50,00)</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="valor"
									placeholder="Valor do produto">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Quantidade de itens: (<em
										class="atributo">amount</em>)<br><strong class="ex">Ex: 1</strong></label>
						...
						<div class="col-lg-3 mt-5 info-body-cartao">
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputEmail1">Nome do cliente: (<em class="atributo">name</em>)
									<br><strong class="ex">Ex: Gorbadoc Oldbuck</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="nome_cliente"
									placeholder="Nome do cliente">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">CPF: (<em class="atributo">cpf</em>) <br><strong
										class="ex">Ex: 94271564656 (sem formatação)</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="cpf"
									placeholder="CPF">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Telefone: (<em class="atributo">phone_number</em>)
									<br><strong class="ex">Ex: 5144916523 (sem formatação)</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="telefone"
									placeholder="Telefone">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Email: (<em class="atributo">email</em>) <br><strong
										class="ex">Ex: email_cliente@servidor.com.br</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="email"
									placeholder="Email">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Data de nascimento: (<em class="atributo">birth</em>)
									<br><strong class="ex">Ex: 1980-08-31 (yyyy-mm-dd)</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="nascimento"
						...
						<div class="col-lg-3 mt-5 info-body-cartao">
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputEmail1">Rua: (<em class="atributo">street</em>) <br><strong
										class="ex">Ex: Avenida Juscelino Kubitschek</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="rua"
									placeholder="Rua">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Número: (<em class="atributo">number</em>)
									<br><strong class="ex">Ex: 10 (int)</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="numero"
									placeholder="Número">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Bairro: (<em class="atributo">neighborhood</em>)
									<br><strong class="ex">Ex: Bauxita</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="bairro"
									placeholder="Bairro">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">CEP: (<em class="atributo">zipcode</em>) <br><strong
										class="ex">Ex: 35400000 (string)</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="cep"
									placeholder="CEP">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Cidade: (<em class="atributo">city</em>) <br><strong
										class="ex">Ex: Ouro Preto</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="cidade"
									placeholder="Cidade">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">Estado: (<em class="atributo">state</em>) <br><strong
										class="ex">Ex: MG</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="estado"
									placeholder="Estado">
							</div>
						</div>
						...
						<div class="col-lg-3 mt-5 info-body-cartao">
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Bandeira: (<em class="atributo">brand</em>)
									<br><strong class="ex">Ex: Visa</strong></label>
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Número do cartão: (<em class="atributo">number</em>)
									<br><strong class="ex">Ex: 4012001038443335</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="numero_cartao"
									placeholder="Número do cartão">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Código de segurança: (<em class="atributo">cvv</em>)
									<br><strong class="ex">Ex: 123</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="codigo_seguranca"
									placeholder="Código de segurança">
							</div>
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Mês de vencimento: (<em
										class="atributo">expiration_month</em>) <br><strong class="ex">Ex:
										1</strong></label>
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputPassword1">Ano de vencimento: (<em
										class="atributo">expiration_year</em>) <br><strong class="ex">Ex:
										2023</strong></label>
							...
							<div id="div_installments" class="form-group alert alert-warning">
								<label for="exampleInputPassword1">Número de parcelas: (<em
										class="atributo">installments</em>) <br><strong class="ex">Ex:
										1</strong></label>
				...
				<div class="col-lg-12 mt-5">
					<button id="ver_parcelas" type="button" class="btn btn-efi-blue icon-success">Definir número de
						parcelas <img src="../assets/img/next.svg"></button>
					<button id="btn_pg_cartao" type="button" class="btn btn-efi-blue icon-success d-none">Confirmar
						pagamento <img src="../assets/img/ok-mark.png"></button>
				</div>
			</div>
			...
			<div class="col-lg-3">
				<div style="margin-top: 45px;" class="col-lg-12 content-guidelines">
					<div class="alert alert-warning" role="alert">
						...
						<b>Atenção!</b><br />
						<p>Para o funcionamento deste exemplo, você deverá informar o <b>Client_Id</b> e
							<b>Client_Secret</b> de sua aplicação (<a href="../assets/img/credenciais.png"
								target="_blank" title="Veja onde localizar o Client_Id e Client_Secret">?</a>) no
							arquivo "./credentials.json", além de alterar o parâmetro <b>sandbox</b>, de acordo com o
							ambiente utilizado ("sandbox => true" para desenvolvimento e "sandbox => false" para
							produção).</p>
						<p>Será necessário também, informar seu <b>Identificador de conta</b> (<a target="_blank"
								href="../assets/img/identificador.png">?</a>) na <b>linha 1</b> do script contido no
							arquivo "./assets/bootstrap/js/payment-token.js".</p>
					</div>
				</div>

				<div class="col-lg-12 mt-5">
					<a href="../download/exemplo-cartao.zip" class="btn btn-efi"><svg class="icon-download"></svg>
						Baixar este exemplo </a>
				</div>
			</div>
		</div>
	</div>
