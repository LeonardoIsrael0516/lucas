		...
		<div class="row">
			<div class="col-lg-9">
				<form id="form" method="POST" action="emitir_pix.php" class="">
					<div class="row">
						<div class="col-lg-4 mt-5 info-body">
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputEmail1">Descrição do produto: (<em
										class="atributo">infoAdicionais</em>)<br><strong class="ex">Ex: Monitor
										LCD</strong></label>
							...
							<div class="form-group">
								<label for="exampleInputPassword1">Valor do produto: (<em
										class="atributo">original</em>)<br><strong class="ex">Ex: 50.00</strong></label>
						...
						<div class="col-lg-4 mt-5 info-body">
							...
							<div class="form-group mt-3 mb-4">
								<label for="exampleInputEmail1">Nome do cliente: (<em class="atributo">nome</em>)
						...
						<div class="col-lg-4 mt-5 info-body">
							...
							<div class="form-group mt-3">
								<label for="exampleInputEmail1">Tempo de expiração: (<em
										class="atributo">expiracao</em>) <br><strong class="ex">3600
										(segundos)</strong></label>
								<input required type="text" class="form-control mt-1 custom-input" id="expiracao"
				...
				<div class="col-lg-12 mt-5">
					<button id="btn_emitir_pix" type="button" class="btn btn-efi-blue icon-success">Emitir Pix <img
							src="../assets/img/ok-mark.png"></button>
				</div>
			</div>
				...
				<div style="margin-top: 45px;" class="col-lg-12 content-guidelines">
					<div class="alert alert-warning" role="alert">
						...
						<p>Para o funcionamento deste exemplo, você deverá informar o <b>Client_Id</b> e
							...
							arquivo "./credentials.json", alterar o parâmetro <b>sandbox</b>, de acordo com o ambiente
							utilizado ("sandbox => true" para desenvolvimento e "sandbox => false" para produção), além
							de informar no atributo <b>certificate</b> o diretório "./certs/", acrescentando o nome do
							seu certificado.</p>
						<p>Será necessário também, no arquivo "./emitir_pix.php", inserir sua chave pix registrada na
							Efí, no parâmetro <b>chave</b>.</p>
					</div>
				</div>

				<div class="col-lg-12 mt-5">
					<a href="../download/exemplo-pix.zip" class="btn btn-efi"><svg class="icon-download"></svg> Baixar
						este exemplo </a>
				</div>
			</div>
		</div>
