...
## **Migration Validator**
If you're already integrated with the Efí PHP SDK and are looking to prepare your application for future innovations in the Efí APIs, you can use our validator to assist in migrating to this SDK.
