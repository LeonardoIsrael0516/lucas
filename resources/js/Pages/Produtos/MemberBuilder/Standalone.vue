...
async function duplicateModule(moduleId) {
    try {
        const { data } = await axios.post(`${base.value}/modules/${moduleId}/duplicate`, {}, { headers: headers() });
...
async function duplicateLesson(lessonId) {
    try {
        const { data } = await axios.post(`${base.value}/lessons/${lessonId}/duplicate`, {}, { headers: headers() });
