...
<template>
    <div class="space-y-8">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div v-for="mod in modules" :key="mod.id" class="rounded-xl border border-zinc-700 bg-zinc-800/50 overflow-hidden">
        ...
        <p v-if="!modules?.length" class="text-center text-zinc-500">Nenhum módulo disponível ainda.</p>
    </div>
</template>
