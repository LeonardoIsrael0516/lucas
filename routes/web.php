...
Route::middleware(['auth', 'admin.tenant', 'role:admin|infoprodutor|team|aluno', 'audit.log'])->group(function () {
...
Route::middleware(['auth', 'admin.tenant', 'role:admin|infoprodutor|team', 'audit.log'])->group(function () {
    ...
    Route::middleware('team.permission:produtos.view')->group(function () {
        ...
        Route::post('/produtos/alunos/{aluno}/send-access', [\App\Http\Controllers\AlunosController::class, 'sendAccess'])->name('alunos.send-access')->where('aluno', '[0-9]+');
    ...
    Route::middleware('team.permission:suporte.view')->group(function () {
        Route::get('/suporte-alunos', [\App\Http\Controllers\SupportTicketsManageController::class, 'index'])->name('support-tickets.index');
        Route::get('/suporte-alunos/{ticket}', [\App\Http\Controllers\SupportTicketsManageController::class, 'show'])->name('support-tickets.show');
        Route::post('/suporte-alunos/{ticket}/reply', [\App\Http\Controllers\SupportTicketsManageController::class, 'reply'])->name('support-tickets.reply');
...
Route::middleware(['auth', 'role:aluno'])->group(function () {
    ...
    Route::post('/suporte/{ticket}/reply', [\App\Http\Controllers\StudentSupportController::class, 'reply'])->name('student-support.reply');
});
