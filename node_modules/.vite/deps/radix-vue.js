...
function $ad063034c8620db8$export$dbc69fd56b53d5e(a2, b2) {
  return a2.isEqual?.(b2) ?? b2.isEqual?.(a2) ?? a2.identifier === b2.identifier;
}
...
function $d07e34cce18680fd$export$1b96692a1ba042ac(ms2, timeZone) {
  let offset2 = $d07e34cce18680fd$export$59c99f3515d3493f(ms2, timeZone);
  ...
  return new (0, $2aaf608024c21ca1$export$d3b7288e7994edea)(year < 1 ? "BC" : "AD", year < 1 ? -year + 1 : year, month, day, timeZone, offset2, hour, minute, second, millisecond);
}
...
function $435a2ceaa8778ed8$export$9a297d111fc86b79(dateTime, field, amount, options) {
  switch (field) {
    case "hour": {
      ...
      ms2 = $435a2ceaa8778ed8$var$cycleValue(hours, amount, Math.floor(minAbsolute / $435a2ceaa8778ed8$var$ONE_HOUR), Math.floor(maxAbsolute / $435a2ceaa8778ed8$var$ONE_HOUR), options?.round) * $435a2ceaa8778ed8$var$ONE_HOUR + remainder;
