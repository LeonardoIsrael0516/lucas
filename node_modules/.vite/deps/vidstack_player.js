import {
  ...
  getTimeRangesStart,
  updateTimeIntervals
} from "./chunk-ZDRPCS4N.js";
import {
  QualitySymbol
} from "./chunk-7OFDZG4P.js";
import {
  ListSymbol
} from "./chunk-RMV4X7CY.js";
import {
  FocusVisibleController
} from "./chunk-E6EW7SID.js";
import {
  coerceToError
...
import {
  mediaContext,
  useMediaContext
} from "./chunk-N5MOQFK6.js";
import {
  isHTMLElement,
  isTouchPinchEvent,
  prefersReducedMotion,
  setAttributeIfEmpty
} from "./chunk-7TR2VQBI.js";
import "./chunk-W5HBWRTZ.js";
import {
  getRequestCredentials,
  preconnect
} from "./chunk-IUHPPIR3.js";
import {
  IS_CHROME,
  IS_IOS,
  IS_IPHONE,
...
import {
  ...
  uppercaseFirstChar,
  waitIdlePeriod
} from "./chunk-YNIV3C7T.js";
import "./chunk-AMSA35GB.js";
import "./chunk-4MBMRILA.js";

// node_modules/vidstack/dev/chunks/vidstack-7RO-J1Y1.js
var GROUPED_LOG = /* @__PURE__ */ Symbol("GROUPED_LOG");
...
var SELECTED = /* @__PURE__ */ Symbol("SELECTED");
...
var AudioProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-audio-254QC6YI.js")).AudioProvider(this.target, ctx);
  }
};
var VideoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-video-LOYIY5OQ.js")).VideoProvider(this.target, ctx);
  }
};
var HLSProviderLoader = class _HLSProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-hls-V5WFMMVO.js")).HLSProvider(this.target, context);
  }
};
var DASHProviderLoader = class _DASHProviderLoader extends VideoProviderLoader {
  ...
  async load(context) {
    ...
    return new (await import("./vidstack-dash-MJJJWFGZ.js")).DASHProvider(this.target, context);
  }
};
var VimeoProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-vimeo-HWOQL3CK.js")).VimeoProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { resolveVimeoVideoId, getVimeoVideoInfo } = await import("./vidstack-krOAtKMi-MI646MOX.js");
...
var YouTubeProviderLoader = class {
  ...
  async load(ctx) {
    ...
    return new (await import("./vidstack-youtube-VZAEKZ3K.js")).YouTubeProvider(this.target, ctx);
  }
  async loadPoster(src, ctx, abort) {
    const { findYouTubePoster, resolveYouTubeVideoId } = await import("./vidstack-Dm1xEU9Q-AGCDLGXK.js");
    const videoId = isString(src.src) && resolveYouTubeVideoId(src.src);
    if (videoId) return findYouTubePoster(videoId, abort);
    return null;
  }
};
var MEDIA_ATTRIBUTES = /* @__PURE__ */ Symbol("MEDIA_ATTRIBUTES");
var mediaAttributes = [
  "autoPlay",
  "canAirPlay",
  "canFullscreen",
  ...
  async requestGoogleCast(trigger) {
    try {
      ...
      if (!this.#googleCastLoader) {
        const $module = await import("./vidstack-C0zlo444-HPYBOMUL.js");
...
var MediaProviderElement = class extends Host(HTMLElement, MediaProvider) {
  ...
  #createGoogleCastContainer() {
    ...
    import("./vidstack-Bl4b0Nen-IDTWSOXK.js").then(({ insertContent }) => {
