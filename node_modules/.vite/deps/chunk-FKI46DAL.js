...
var CROSS_ORIGIN = /* @__PURE__ */ Symbol("TEXT_TRACK_CROSS_ORIGIN");
var READY_STATE = /* @__PURE__ */ Symbol("TEXT_TRACK_READY_STATE");
var UPDATE_ACTIVE_CUES = /* @__PURE__ */ Symbol("TEXT_TRACK_UPDATE_ACTIVE_CUES");
var CAN_LOAD = /* @__PURE__ */ Symbol("TEXT_TRACK_CAN_LOAD");
var ON_MODE_CHANGE = /* @__PURE__ */ Symbol("TEXT_TRACK_ON_MODE_CHANGE");
var NATIVE = /* @__PURE__ */ Symbol("TEXT_TRACK_NATIVE");
var NATIVE_HLS = /* @__PURE__ */ Symbol("TEXT_TRACK_NATIVE_HLS");
var TextTrackSymbol = {
...
var TextTrack = class extends EventsTarget {
  ...
  #parseContent(init) {
    import("./dev-BCOEN4UC.js").then(({ parseText, VTTCue, VTTRegion }) => {
  ...
  async #load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import("./dev-BCOEN4UC.js"), crossOrigin = this[TextTrackSymbol.crossOrigin]?.();
...
//# sourceMappingURL=chunk-FKI46DAL.js.map
