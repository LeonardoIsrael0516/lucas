...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await import("./srt-parser-TCREGMAW.js")).default;
        break;
      case "ssa":
      case "ass":
        factory = (await import("./ssa-parser-IXIHZQQY.js")).default;
        break;
      default:
...
var VTTParser = class {
  ...
  async init(init) {
    ...
    if (init.strict)
      this._block = 1;
    if (init.errors)
      this._errorBuilder = (await import("./errors-HYB6Y2MA.js")).ParseErrorBuilder;
  }
...
var STARTING_BOX = /* @__PURE__ */ Symbol("STARTING_BOX");
...
var POSITION_OVERRIDE = /* @__PURE__ */ Symbol("POSITION_OVERRIDE");
...
//# sourceMappingURL=chunk-YMKRNRLO.js.map
